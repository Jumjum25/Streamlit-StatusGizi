...
# membaca model
GiziAnak_model = pickle.load(open('StatusGiziAnak_model.sav', 'rb'))
...
if st.button('Status Gizi Anak'):
    datagizi_prediction = GiziAnak_model.predict([[Jenis_Kelamin, Umur_Bulan, Berat_Badan, Tinggi_Badan]])
